...
@SpringBootTest
class LangChainAgentApplicationTests {
    ...
    @Test
    public void testEnv() {
        System.out.println(environment.getProperty("langchain4j.community.dashscope.chat-model.api-key"));
    }
    ...
    public void testSpringBoot() {
        String answer = openAiChatModel.chat("你好，请介绍一下你自己");
        System.out.println(answer);
    }
...
//        String answer = ollamaChatModel.chat("你好，请介绍一下你自己");
//        System.out.println(answer);
//    }
...
//    // Ali: Wanx Image-generate model
//    @Test
//    public void testDashScopeWanx(){
//        WanxImageModel wanxImageModel = WanxImageModel.builder()
//                .modelName("wanx2.1-t2i-turbo")
//                .apiKey(environment.getProperty("langchain4j.community.dashscope.chat-model.api-key"))
//                .build();
